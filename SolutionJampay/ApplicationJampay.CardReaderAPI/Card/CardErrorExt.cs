...
{
    public static class CardErrorExt
    {
        /// <summary>
        /// Throws an exception if <paramref name="sc"/> is not <see cref="SCardError.Success"/>.
        /// </summary>
        /// <param name="sc">error code to check</param>
        public static void ThrowIfNotSuccess(this SCardError sc)
        {
        ...
        /// </summary>
        /// <param name="sc">error code to check</param>
        public static void Throw(this SCardError sc)
        {
            switch (sc)
            {
