...
using SCARD_IO_REQUEST_WINDOWS = ApplicationJampay.CardReaderAPI.Interop.Windows.SCARD_IO_REQUEST;
using SCARD_IO_REQUEST_UNIX = ApplicationJampay.CardReaderAPI.Interop.Unix.SCARD_IO_REQUEST;
