...
using WINDOWS_SCARD_READERSTATE = ApplicationJampay.CardReaderAPI.Interop.Windows.SCARD_READERSTATE;
using UNIX_SCARD_READERSTATE = ApplicationJampay.CardReaderAPI.Interop.Unix.SCARD_READERSTATE;
