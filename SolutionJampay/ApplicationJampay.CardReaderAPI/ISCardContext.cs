using ApplicationJampay.CardReaderAPI.Card;
...
namespace ApplicationJampay.CardReaderAPI
{
    public interface ISCardContext : IDisposable
    {
        ...
        /// <returns>
        ///     <para>A <see cref="SCardError.Success" /> indicating an error or the success.The caller receives status changes through the <see cref="SCardError.NoService" /> array.</para>
        ///     <list type="table">
        ///         <listheader>
        ///             <term>Return value</term>
        ///             <description>Description</description>
        ...
        ///         <item><term><see cref="SCardError.InvalidHandle" /></term><description>Invalid context (SCARD_E_INVALID_HANDLE)</description></item>
        ///         <item><term><see cref="SCardError.NoService" /></term><description>Server is not running (SCARD_E_NO_SERVICE)</description></item>
